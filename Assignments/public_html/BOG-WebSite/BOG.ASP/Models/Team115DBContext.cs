...
{
    public partial class Team115DBContext : DbContext
    {
        public Team115DBContext()
        {
        }

        public Team115DBContext(DbContextOptions<Team115DBContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=buscissql1601\\cisweb;Database=Team115DB;User ID=exposed;Password=source;");
            }
        }
