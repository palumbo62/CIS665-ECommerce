...
*/ 
    ...
    if (!empty($userId)) {
        $tag = "Account Profile Information";
    } else {
    ...
    // Retrieve the user profile for the current user but only if it hasn't
    if ($_SESSION['userReset'] == true) {
...
?>
    ...
    <section id="bannerList">       
        <h2>User Account</h2> 
        <button name="viewReserve" type="submit" value="reserve" 
                onclick="location.href='BogViewReservationsUserId.php';return false;">View Reservations</button>
    </section>
    ...
    <section id="banner">
        <form action="BogUserProfileAction.php" method='post'>
            ...
            <div class="containerAddProp">
                ...
                <input class="BogInput" type="text" name="email" id="readonly" readonly
                       required autofocus
                ...
                <select class="BogInput" id="state" name="state" required
                ...
                <!--RLP DONT NEED
                <button name="userReset" type="submit" value="reset">Reset</button>-->
