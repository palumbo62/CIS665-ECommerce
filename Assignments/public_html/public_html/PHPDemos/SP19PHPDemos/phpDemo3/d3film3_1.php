...
// XRLP NOTE: 
// $_GET is a SUPER GLOBAL array in PHP that auto-fills with the 
//      URL parameter tags
// isset() indicates if the $_GET array has an element called 'filmpk'
// is_numeric($_GET['filmpk'] tests to ensure element is numeric
if (!isset($_GET['filmpk'])|| !is_numeric($_GET['filmpk']))
{
    // XRLP NOTE:
    // header() is a 'redirect' sending user back to the indicated page
