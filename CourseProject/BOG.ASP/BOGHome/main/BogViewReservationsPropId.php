...
*/ 
    ...
    $resvProfs = bogGetReservProfsByPropId($propId);
    ...
    if (($errCode = bogGetLastErrorCode()) != 0) { 
        ...
        $err = "There are currently no reservations for this property!";
    }
    ...
    $tag = "Viewing Reservations for Property ID '$propId'";
...
?>
    ...
    <section id="bannerBlue">
        ...
        <br>
        <button type="submit" onclick="location.href='BogSelectedView.php?propId=<?php echo $propId ?>';return false;">Return</button>
    </section>
