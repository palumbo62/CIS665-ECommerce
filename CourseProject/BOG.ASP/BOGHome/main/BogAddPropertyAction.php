...
*/ 
    ...
    if (isset($listing)) {
        ...
        $propdesc = (isset($_POST['propdesc'])) ? $_POST['propdesd'] : '';
        
        $imageName = bogUploadImage();
        echo "ImageName='$imageName'<br><br>";
...
//        die();
        ...
        bogAddPropProf($proptype, $title, $address, $city, $state, 
                        ...
                        $sqft, $guests, $pic, $imageName, $propdesc);
        ...
        if (($errCode = bogGetLastErrorCode()) != 0) {
            ...
            alertRedirect(3, 'BogAddProperty.php', 
                          "A property listing with the specified address already exists!");
        } else {
