...
/****** Object:  StoredProcedure [dbo].[spBogAddPropProf]    Script Date: 2/28/2019 9:38:14 AM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    ...
    IF (@@ROWCOUNT = 1)
        BEGIN
            -- Address already exists in the DB so return an error
            RETURN -1;
        END
