...
*/
    ...
    displayPageHeader('BOG - Test testBogMakeReserv');
...
<form name ="addReservation" id="addForm" action="testBogAddReservProf.php" method="post" onsubmit="return checkForm(this)">
