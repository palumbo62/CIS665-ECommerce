...
/*
    ...
    Filename:       testGetCommentsByUserId.php
...
*/
    ...
    displayPageHeader('BOG - Test bogGetCommentsByUserId()');

    echo '<section>';

    $propId = 11;
    $comments = bogGetCommentsByUserId($propId);
    ...
    if (($errCode = bogGetLastErrorCode()) != 0) { 
        ...
        echo "Comments for userId='$propId' not found!<br><br>";
    } else {
