...
*/ 
    ...
    echo "title='$title', propType='$proptype', "
...
HTML;
                ...
                <label for="numbeds">Bedrooms:&nbsp;</label>
                <input type="number" name="numbeds" id="numbeds" required 
                ...
                <label for="numbaths">Bathrooms:&nbsp;</label>
                <input type="number" name="numbaths" id="numbaths" required 
                       maxlength="3" min="0" max="50"
                ...
                <label for="guestcnt">Sleeps:&nbsp;</label>
                <input type="number" name="guestcnt" id="guestcnt" required 
                       maxlength="3" min="0" max="50" 
